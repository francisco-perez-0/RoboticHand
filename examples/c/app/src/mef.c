...
// Defno los niveles de resolucion y el angulo que girar� el servo
// EL final ser� 2^level niveles distintos de giro
	...
	switch (actState){
		...
		case CONNECTING:
			...
			if(uartReadByte(UART_USB, &initMsg)){	//Espero mensaje de comienzo de comunicacion
				if(initMsg == 'a'){
					// se deber� esperar un aX (donde X = 1, 2, 3, 4, 5, 6, 7, 8)
